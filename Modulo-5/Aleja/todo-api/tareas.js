let tareas = [
    { id: 1, titulo: 'Terminar el taller de Express.js', completada: false }, { id: 2, titulo: 'Hacer las compras', completada: true }, { id: 3, titulo: 'Limpiar el apartamento', completada: false }
];
